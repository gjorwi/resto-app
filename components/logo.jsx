...
export default function Logo() {
  return (
    <motion.div initial={{scale:0,opacity:0}}
      ...
      className="w-40 h-40 lg:w-64 lg:h-64 rounded-full bg-white border-2 left-[30%] overflow-hidden flex flex-col justify-center shadow-md shadow-slate-200 items-center">
