...
export default function Logo() {
  return (
    <motion.div initial={{scale:0,opacity:0}}
      ...
      className="w-40 h-40 lg:w-64 lg:h-64 rounded-full relative bg-white border-2  overflow-hidden flex flex-col justify-center shadow-md shadow-slate-200 items-center">
      <div className="absolute top-0 left-0 w-full h-full"> <MyFoto foto={'/img/gorro.png'}/></div>
